      ...
      <div className="flex items-center gap-2 shrink-0">
        ...
        <div>
          <h1 className="text-sm font-bold text-slate-800 leading-tight whitespace-nowrap">
            Elpusk MSR Reader <span className="text-slate-500 font-medium">{APP_VERSION}</span>
          </h1>
          <p className="text-[10px] text-slate-400 font-medium leading-tight">LPU237 Magnetic Card Reader</p>
        </div>
      </div>
